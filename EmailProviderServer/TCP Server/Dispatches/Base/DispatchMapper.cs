    ...
    public class DispatchMapper
    {
        ...
        public BaseDispatchHandler MapDispatch(int dispatchCode)
        {
            switch ((DispatchEnums)dispatchCode)
            {
                ...
                case DispatchEnums.ReceiveEmails:
                    return ActivatorUtilities.CreateInstance<ReceiveEmailDispatchS>(_serviceProvider);
                case DispatchEnums.LoadOutgoingEmails:
                    return ActivatorUtilities.CreateInstance<LoadOutgoingEmailsDispatchS>(_serviceProvider);
                case DispatchEnums.LoadIncomingEmails:
                    return ActivatorUtilities.CreateInstance<LoadIncomingEmailsDispatchS>(_serviceProvider);
                default:
